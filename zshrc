...
export PATH=$HOME/.local/bin:$PATH:/usr/local/go/bin:~/go/bin
...
plugins=(git zsh-syntax-highlighting zsh-autosuggestions z zsh-history-substring-search aws gcloud kubectl-autocomplete)
)
